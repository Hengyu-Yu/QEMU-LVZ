...
DEF_HELPER_2(invtlb_all, void, env, i32)
...
DEF_HELPER_2(invtlb_all_gid, void, env, tl)
DEF_HELPER_3(invtlb_all_g_gid, void, env, i32, tl)
DEF_HELPER_2(invtlb_all_asid_gid, void, env, tl)
DEF_HELPER_3(invtlb_page_asid_gid, void, env, tl, tl)
DEF_HELPER_3(invtlb_page_asid_or_g_gid, void, env, tl, tl)
